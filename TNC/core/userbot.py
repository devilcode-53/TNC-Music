...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("ALL_TNCxMUSIC_BOT")
                await self.one.join_chat("TNCmeetup")
            except:
                pass
            assistants.append(1)
            try:
                await self.one.send_message(-1003128590255, "Assistant Started")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("ALL_TNCxMUSIC_BOT")
                await self.one.join_chat("TNCmeetup")
            except:
                pass
            assistants.append(2)
            try:
                await self.two.send_message(-1003128590255, "Assistant Started")
            except Exception as e:
                LOGGER(__name__).error(
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("ALL_TNCxMUSIC_BOT")
                await self.one.join_chat("TNCmeetup")
            except:
                pass
            assistants.append(3)
            try:
                await self.three.send_message(-1003128590255, "Assistant Started")
            except Exception as e:
                LOGGER(__name__).error(
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("ALL_TNCxMUSIC_BOT")
                await self.one.join_chat("TNCmeetup")
            except:
                pass
            assistants.append(4)
            try:
                await self.four.send_message(-1003128590255, "Assistant Started")
            except Exception as e:
                LOGGER(__name__).error(
        ...
        if config.STRING5:
            ...
            assistants.append(5)
            try:
                await self.five.send_message(-1003128590255, "Assistant Started")
            except Exception as e:
                LOGGER(__name__).error(
